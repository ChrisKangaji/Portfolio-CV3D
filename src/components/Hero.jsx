...
import { ComputerCanvas, EarthCanvas } from './canvas';
  ...
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className="text-[#915eff]">Chris
                {/* <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
          ...
          <h3 className="home__subtitle">Christian Kangaji{text}{isBlinking ? <span className="blinking-cursor">|</span> : <span>|</span>}</h3>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            I am a Developer based in Stockholm, Sweden. <br className="sm:block hidden" />
            I'm passionate about coding and I love to learn new things.
