...
export const About: ComponentType<any>;
export const Contact: ComponentType<any>;
export const Experience: ComponentType<any>;
export const Feedbacks: ComponentType<any>;
